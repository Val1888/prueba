package com.example.clone_funalito.vista_modelos
...
import com.example.clone_funalito.API.RepositorioFunalito
import com.example.clone_funalito.modelos.Publicacion
import kotlinx.coroutines.launch

class FulanitoViewModel: ViewModel() {
    private val repositorio_de_datos = RepositorioFunalito()
